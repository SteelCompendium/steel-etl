...
| Main Action | main action, main actions | new-rule | mcdm.heroes.v1/rule.combat/main-action | `### Main Actions` (21836) | The action category. Individual common main actions are `feature.trait.common.main-actions/<id>`. |
| Malice | malice | skip | | | Monsters-book resource ("See Draw Steel: Monsters"); no rules content or home in the heroes book. |
| Maneuver | maneuver, maneuvers | new-rule | mcdm.heroes.v1/rule.combat/maneuver | `### Maneuvers` (21724) | Action category. Individual common maneuvers are `feature.trait.common.maneuvers/<id>`. |
...
| Move Action | move action, move actions | new-rule | mcdm.heroes.v1/rule.combat/move-action | `### Move Actions` (21704) | Action category. Individual common move actions are `feature.trait.common.move-actions/<id>`. |
...
| Turn | turn, turns | new-rule | mcdm.heroes.v1/rule.combat/turn | NO HEADING — needs new heading OR map to nearest parent: Combat Round. Best parent `mcdm.heroes.v1/rule.combat/combat-round` (`#### Combat Round` 21354) | Defined in glossary; "main action, maneuver, move action." Common word — link in combat context. Flag for a Turn heading. |
